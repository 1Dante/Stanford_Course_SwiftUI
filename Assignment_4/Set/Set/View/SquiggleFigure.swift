...
struct SquiggleFigure: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        let transformScale = CGAffineTransform(scaleX: 0.9524 * rect.width / 80 , y: 0.9524 * rect.height / 60 )
        path = path.applying(transformScale)
